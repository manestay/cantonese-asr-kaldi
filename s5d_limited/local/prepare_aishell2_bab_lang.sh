...
# This script prepares a dictionary for aishell2-to-bab transfer learning experiment,
# which uses aishell2 phone set phones.txt, lexicon lexicon.txt and dict.
